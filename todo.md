...
- [x] Implement a versioned offline screenshot project schema with image data, annotations, transforms, serialization, and validation.
- [x] Build a local image viewer with upload, zoom, pan, crop, region selection, labels, notes, and annotated-image export.
